...
/* SIZEOF_SYSTEM_PAGE == 4096 || SIZEOF_SYSTEM_PAGE == 8192 || SIZEOF_SYSTEM_PAGE == 16384 checked by configure */
#if SIZEOF_SYSTEM_PAGE == 16384
#define LOG_BIT_SIZEOF_SYSTEM_PAGE 14
#elif SIZEOF_SYSTEM_PAGE == 8192
