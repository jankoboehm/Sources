...
#ifdef __cplusplus
extern "C" VAR BITSET si_opt_1; //< NOTE: Original option variable name: test
extern "C" VAR BITSET si_opt_2; //< NOTE: Original option variable name: verbose
#else
EXTERN_VAR BITSET si_opt_1;
EXTERN_VAR BITSET si_opt_2;
#endif
